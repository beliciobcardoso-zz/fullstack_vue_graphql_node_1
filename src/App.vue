				...
				<div class="row">
					<div class="col-md">
						...
						<div class="card">
							<div class="card-body">
								<ul class="list-group">
									<li class="list-group-item" v-for="prefixe in prefixes" v-bind:key="prefixe">{{prefixe}}</li>
								</ul>
								<br />
					...
					<div class="col-md">
						...
						<div class="card">
							<div class="card-body">
								<ul class="list-group">
									<li class="list-group-item" v-for="sufixe in sufixes" v-bind:key="sufixe">{{ sufixe}}</li>
								</ul>
								<br />
								<div class="input-group">
